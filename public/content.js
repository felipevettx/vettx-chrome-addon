  ...
  try {
    while (isScrapingActive) {
      ...
      try {
        ...
        retryCount = 0; // Reiniciar el contador de reintentos en caso de éxito
        ...
        noNewProductsCount = 0; // Reiniciar el contador cuando se encuentran nuevos productos
        allProducts = [...allProducts, ...newProducts];
        totalProductsScraped = allProducts.length;

        console.log(`Total de productos encontrados: ${totalProductsScraped}`);

        // Enviar resultados parciales al script de fondo
        ...
        console.log(`Ocurrió un error. Reintento ${retryCount}/${MAX_RETRIES}`);
      }
    }
    ...
    // Enviar resultados finales al script de fondo
    chrome.runtime.sendMessage({
